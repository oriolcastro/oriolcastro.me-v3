---
title: '[CAT] Disseny del projecte #2 Gener - Repte6by6'
...
- **NOU:** Tota la lògica de servidor estarà distribuïda en diferents *lambda functions* implementades a través del servei de [Netlify functions](https://www.netlify.com/features/functions/).
- **NOU:** Faré ús dels *[event triggers](https://hasura.io/event-triggers)* de Hasura per executar les funcions a partir de canvis a la base de dades.
